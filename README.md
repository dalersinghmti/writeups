...
## Contents 
 ...
 - [Cross Site Scripting (XSS)](https://github.com/dalersinghmti/writeups#cross-site-scripting-xss)
 - [Cross Site Request Forgery (CSRF)](https://github.com/dalersinghmti/writeups#cross-site-request-forgery-csrf)
 - [Clickjacking (UI Redressing Attack)](https://github.com/dalersinghmti/writeups#clickjacking-ui-redressing-attack)
 - [Local File Inclusion (LFI)](https://github.com/dalersinghmti/writeups#local-file-inclusion-lfi)
 - [Subdomain Takeover](https://github.com/dalersinghmti/writeups#subdomain-takeover)
 - [Denial of Service (DOS)](https://github.com/dalersinghmti/writeups#denial-of-service-dos)
 - [Authentication Bypass](https://github.com/dalersinghmti/writeups#authentication-bypass)
 - [SQL injection](https://github.com/dalersinghmti/writeups#sql-injectionsqli)
 - [Insecure Direct Object Reference (IDOR)](https://github.com/dalersinghmti/writeups#insecure-direct-object-reference-idor)
 - [2FA Related issues](https://github.com/dalersinghmti/writeups#2fa-related-issues) 
 - [CORS Related issues](https://github.com/dalersinghmti/writeups#cors-related-issues)
 - [Server Side Request Forgery (SSRF)](https://github.com/dalersinghmti/writeups/README.md#server-side-request-forgery-ssrf)
 - [Race Condition](https://github.com/dalersinghmti/writeups/README.md#race-condition)
 - [Remote Code Execution (RCE)](https://github.com/dalersinghmti/writeups#remote-code-execution-rce)
 - [Android Pentesting](https://github.com/dalersinghmti/writeups#android-pentesting) 
 - [Contributing](https://github.com/dalersinghmti/writeups#contributing)
 - [Maintainers](https://github.com/dalersinghmti/writeups#maintainers)
